...
app.post('/api/analyze', apiLimiter, async (req, res) => {
    // --- THIS IS THE FIX ---
    // This logic now correctly checks for the keys of ONLY the selected service.
